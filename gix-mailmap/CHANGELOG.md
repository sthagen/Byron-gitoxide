...
### New Features (BREAKING)
 ...
 - <csr-id-325ac9fa4324588b10338b2c2c10f848b6eaf072/> `gix-error` instead of `thiserror` in `gix-mailmap`
 ...
 * **Uncategorized**
    ...
    - `gix-error` instead of `thiserror` in `gix-mailmap` ([`325ac9f`](https://github.com/GitoxideLabs/gitoxide/commit/325ac9fa4324588b10338b2c2c10f848b6eaf072))
